package org.usfirst.frc.team3335.vision;
...
public class TowerTracker {
	...
	public static void logRect(Rect rec, double distance, double azimuth) {
		System.out.println(String.format("Distance %.2f azimuth %.2f ", distance, azimuth)
				+ " center x " + 0.5*(rec.tl().x + rec.br().x)
				+ " center y " + 0.5*(rec.tl().y + rec.br().y)
