...
public class GripPipelineTwo {
  ...
  public void process(Mat source0) {
    ...
    double[] hslThresholdHue = { 45, 118.25 };
    double[] hslThresholdSaturation = { 108.0, 255.0 };
    double[] hslThresholdLuminance = { 118.1, 255.0 };
