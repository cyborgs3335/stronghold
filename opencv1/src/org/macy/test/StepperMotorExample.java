...
public class StepperMotorExample {
   ...
   */
  public StepperMotorExample(String portName, boolean addEventListener) throws SerialPortException {
  ...
  public static void main(String[] args) {
    ...
    Thread t = new Thread(new Runnable() {
      ...
      @Override
      public void run() {
        StepperMotorExample comm;
        try {
          comm = new StepperMotorExample(portName, false/*true*/);
        } catch (SerialPortException e) {
