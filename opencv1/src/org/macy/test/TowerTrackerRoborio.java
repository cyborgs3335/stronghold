 ...
 *
 */
public class TowerTrackerRoborio implements Runnable {
  ...
  public TowerTrackerRoborio() {
    this(new VideoSource(), null);
  }

  public TowerTrackerRoborio(int cameraDeviceID, ImagePanel panel) {
    this(new VideoSource(cameraDeviceID), panel);
  }

  public TowerTrackerRoborio(VideoSource videoSource, ImagePanel panel) {
